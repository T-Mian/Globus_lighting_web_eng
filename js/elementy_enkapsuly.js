...
let obiekt_footer_raliza_ang=`
        <div class="row_foot">
        <!-- obiekt_footer_raliza_ang -->
          <div class="column_foot">
            <h2 style="text-transform: uppercase;letter-spacing: 2.4px;"> 
            <i class="fa-regular fa-address-book"></i>
            &nbsp Contact details 
            </h2>
            <p>
            <i class="fa-regular fa-envelope"></i>
            &nbsp GL Sp. z o.o.
          ...
          <div class="column_foot">
            ...
            comes from the Globus company with nearly 100 years of tradition.We started
              with tools for the industry, now we are a separate
              company who is Polish, 
              <span>
              <a href="../solutions_folder/industrial_LED.html">
              producer of industry
              </a>
              </span>
              and specialist lighting. LED lighting is amazing saving and durable so we would like
              to invite all interested to contact with us. As a producer of LED lighting
              we create not only for industry but also 
              <a href="../solutions_folder/street_lighting_ENEC.html">
              street
              </a>,
              <span>
...
let obiekt_footer_raliza_fr=``;
let obiekt_footer_raliza_pl=``;

let obiekt_menu_reliza_ang=`
          <li>
            <a href="../index.html">
              <i class="fa-solid fa-house"></i>
              Home
          ...
          <li id="closeBurger" onclick="togleMenu()"><i class="fa-solid fa-bars-staggered"></i></li>`;
let obiekt_menu_reliza_fr=``
let obiekt_menu_reliza_pl=``


let mont_menu_real =  document.getElementById("menu_in_situ_realizac");
let mont_foot_real =  document.getElementById("stopka_web_realis");
